          ...
          j.raw.series.forEach(
            function (e, g) {
              if (0 !== j.normalized.series[g] || !a.ignoreEmptyValues) {
                ...
                var r = c.polarToCartesian(n.x, n.y, f, q),
                  s = c.polarToCartesian(n.x, n.y, f, p),
                  t = new c.Svg.Path(!a.donut)
                    .move(s.x, s.y)
                    .arc(f, f, 0, p - l > 180, 0, r.x, r.y);
                a.donut || t.line(n.x, n.y);
                var u = k[g].elem(
                  "path",
                  { d: t.stringify() },
                ...
                if (
                  ...
                  a.donut &&
                    u.attr({ style: "stroke-width: " + m.value + "px" }),
                  this.eventEmitter.emit("draw", {
                    type: "slice",
                  ...
                  var x = a.labelInterpolationFnc(w, g);
                  if (x || 0 === x) {
                    var y = b
                      .elem(
                        "text",
                        {
                          dx: v.x,
                          dy: v.y,
                          "text-anchor": d(n, v, a.labelDirection),
                        },
                        a.classNames.label
                      )
                      .text("" + x);
