...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    if (e) {
      ...
      if (((t = i ? Collapse.getInstance(i) : null), t && t._isTransitioning))
        return;
    }
...
class Dropdown extends BaseComponent {
  ...
  _selectMenuItem({ key: e, target: t }) {
    ...
    n.length &&
      getNextActiveElement(n, t, "ArrowDown" === e, !n.includes(t)).focus();
  }
  ...
  static dataApiKeydownHandler(e) {
    ...
    return "Escape" === e.key
      ...
      ? (t || n().click(), void Dropdown.getInstance(n())._selectMenuItem(e))
...
class Backdrop {
  ...
  _getConfig(e) {
    return (
      ((e = { ...Default$6, ...("object" == typeof e ? e : {}) }).rootElement =
